    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            models = {
                ...
                "XGBRegressor": XGBRegressor(tree_method="gpu_hist", gpu_id=1, n_jobs=-1, verbosity=0),
                "CatBoosting Regressor": CatBoostRegressor(task_type="GPU", devices='1', verbose=False),
            ...
            logging.info(f"Test R2 score for best model: {r2_square}")
